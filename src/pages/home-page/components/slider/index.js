        ...
        <div className={style["slider"]}>
            ...
            <div className={style["TV-show"]}>
                <div className={style["left-show"]}>
                    ...
                    <p className={style["sub-title"]}>Ngày phát sóng: 6/3/2023 | 0 comment</p>
                    ...
                    <div className={style["featured-video"]}>
                        <ul>
                            <div className={style["featured-new"]} href="#">
                                <img width="100%" height="225" src="https://haylentieng.vn/wp-content/uploads/2018/07/logo-300x200.jpg"></img>
                            </div>
